...
import '@fortawesome/fontawesome-free/css/all.min.css';       // chatgpt
      ...
      <MainContainer>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.right_section_indexing}>
            {/* Buttons to naviagate between main and whatsapp  */}
            ...
            {/*chatgpt  */}
  <a
    href="mailto:krguddu68@gmail.com"  // <-- replace with your actual email
    target="_blank"
    // rel="noopener noreferrer"
    className={`${styles.btn} ${styles.mail_btn}`}
  >
    <i className={`fa-solid fa-envelope ${styles.button_icon} ${styles.mail_icon}`}></i>
    Send Mail
  </a>
  
  <a
    href="https://wa.me/919525132113"  // <-- replace with your actual WhatsApp number
    target="_blank"
    rel="noopener noreferrer"
    className={`${styles.btn} ${styles.whatsapp_btn}`}
  >
    <i className={`fa-brands fa-whatsapp ${styles.button_icon} ${styles.whatsapp_icon}`}></i>
    Whatsapp
  </a>
            {/* Location Section  */}
