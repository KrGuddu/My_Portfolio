    ...
    <>
      <div ref={navbar}  className={style.navbar}>
        ...
        <ul className={style.navlist}>
          ...
          {/* <li>
            <NavLink className={style.navigation} to="/experiance">
              <span className={style.nav_icons}>
        ...
        <div className={style.social_media_section}>
          ...
          <a
            href="https://x.com/guddukumar57761?t=luBn1QUMrF6gWuGKdBhg7g&s=09"
            target="_blank"
            rel="noopener noreferrer"
            className={style.link}
          >
          ...
          <a
            href="https://www.instagram.com/krguddu_954?igsh=N3k4OWduenF0cmZp"
            target="_blank"
            rel="noopener noreferrer"
            className={style.link}
          >
